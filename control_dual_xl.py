...
class MotorController(Node):
    ...
    def init_dynamixel(self):
        ...
        # Enable torque for the motor and Use Velocity Control Mode
    ...
    def speed_callback(self, msg):
        speed1 = -msg.motorspeed1  # Only use the first motor speed

        dxl_comm_result1 = self.packetHandler.write4ByteTxRx(self.portHandler, DXL_ID, ADDR_GOAL_VELOCITY, int(speed1))
        ...
        if dxl_comm_result1 != COMM_SUCCESS:
            ...
            rclpy.logging.get_logger('dynamixel_controller').info("Set [ID: %d] [Goal Velocity: %d]" % (DXL_ID, msg.motorspeed1))
